...
date_20_pctile = kaggle_headline_data['Date'].drop_duplicates().quantile(0.2)
date_40_pctile = kaggle_headline_data['Date'].drop_duplicates().quantile(0.4)
date_60_pctile = kaggle_headline_data['Date'].drop_duplicates().quantile(0.6)
date_80_pctile = kaggle_headline_data['Date'].drop_duplicates().quantile(0.8)
